...
namespace ConsoleApp1
{
    static class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(Neo.Wallets.Wallet.ToAddress(new UInt160("0xeee76c45175b5af08630b2278a24803368284a1e".Remove(0, 2).HexToBytes().Reverse().ToHexString().HexToBytes())));            
